 ...
 *   [reactionTime, inhibition, workingMemory, vitesse_visuo_perceptuelle, flexibility]
...
export async function exportTeamReport(
  ...
  const dimLabels = ["TR", "Inhibition", "Mém. travail", "Vitesse V.-P.", "Flexibilité"];
